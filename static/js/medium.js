$(function () {
    var board = $('#board')[0];
    var size = 19;
    var current = true;      // true=player, false=ai
    var currentColor = true;     // true = white, false=black
    var over = false;

    board.init = function () {
        this.moves = [];
        over = false;
        current = !$('[name="choice"]')[0].checked;   // i am false by default
        currentColor = !current;    // color is black
        var playerIndex = current ? 1 : -1;   // ai =-1
        this.draw();
